...
class ADODB_ldap extends ADOConnection
{
    ...
    public function _connect($host, $username, $password, $ldapbase)
    {
        ...
        if (0 === strpos($host, 'ldap://') || 0 === strpos($host, 'ldaps://')) {
    ...
    */
    ...
    public function ServerInfo()
    {
        ...
        */
        ...
        if (0 == $version['LDAP_OPT_SIZELIMIT']) {
        ...
        */
        ...
        if (0 == $version['LDAP_OPT_TIMELIMIT']) {
        ...
        */
        ...
        if (0 == $version['LDAP_OPT_REFERRALS']) {
        ...
        */
        ...
        if (2 == $version['LDAP_OPT_PROTOCOL_VERSION']) {

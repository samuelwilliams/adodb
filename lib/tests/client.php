...
if ($testhttp) {
    echo '<a href=#c>Client Driver Tests</a><p>';
...
echo '<a name=c><h1>CLIENT Driver Tests</h1>';
...
echo '<h3>Insert SQL 1</h3>';
$rs = $conn->Execute($sql2);

echo '<h3>Insert SQL 2</h3>';
$rs = $conn->Execute($sql3);

echo '<h3>Select SQL</h3>';
$rs = $conn->Execute($sql5);
if ($rs) {
    rs2html($rs);
}

echo '<h3>Delete SQL</h3>';
